...
public class Game extends Application {
  ...
  private Label scoreupBonus;
  private Label slowdownBonus;
  private Label sizeupBonus;
  private Label luckyBonus;
  ...
  public void init() {
    ...
    scoreupBonus = new Label("");
    scoreupBonus.setFont(Font.font(15));
    
    slowdownBonus = new Label("");
    slowdownBonus.setFont(Font.font(15));
    
    sizeupBonus = new Label("");
    sizeupBonus.setFont(Font.font(15));
    
    luckyBonus = new Label("");
    luckyBonus.setFont(Font.font(15));
    ...
    luckyBonus.setText("Lucky: " + (int)(itemRateIncrease*100) + "%");
  ...
  public void start(Stage mainStage) {
    ...
    Label perkBonuses = new Label("Perk Bonuses");
    perkBonuses.setFont(Font.font(25));
    ...
    statusPane.getChildren().addAll(timerLabel, lifeLabel, scoreLabel, gameSpeedLabel,
    								new Separator(), perkBonuses,
    								scoreupBonus, slowdownBonus, sizeupBonus, luckyBonus);
